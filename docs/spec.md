...
| **Problèmes avec donnée superflue** | L'enfant doit sélectionner les données pertinentes — le surlignage gris rend cet exercice explicite. Ajouter 3-4 problèmes dans les catégories existantes. |
...
| **P3** | **Enrichir banque de problèmes** | ≥2 problèmes "construire un diagramme à bandes" (2e-3e cycle) + 3-4 problèmes avec données superflues. Effort faible, impact curriculaire direct. |
