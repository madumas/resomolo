...
### v1.1 — Outils mathématiques

Enrichir le répertoire de pièces et compléter l'arithmétique.

| Feature | Notes | Effort |
|---|---|---|
| **Droite numérique** | Nouvelle pièce sémantique. Aspect ordinal du sens du nombre (Siegler & Ramani 2009). Essentiel 1er cycle + difficultés en math. | Gros |
| ~~**Multiplication multi-chiffres complète**~~ | ✅ Livré — lignes intermédiaires auto-générées pour multiplicateur multi-chiffres. | — |
| **Division longue en colonnes** | Layout spécifique (diviseur à gauche, quotient en haut). Complète les 4 opérations. | Moyen |
| **Phrases-réponses à trous** | « Il en reste ___ pommes. » Aide à la formulation. | Moyen |

### v1.2 — Accessibilité comorbidités

Adaptations pour les profils combinés les plus fréquents.

| Feature | Comorbidité ciblée | Effort |
|---|---|---|
| **Synthèse vocale (TTS)** — Web Speech API | Difficultés en lecture (30-40%) | Moyen |
| **Police et espacement configurables** — OpenDyslexic/Luciole | Difficultés en lecture (Zorzi 2012) | Moyen |
| **Mode lecture guidée** — segmentation phrase par phrase | Difficultés en lecture/compréhension | Moyen |

### v1.3 — Infrastructure enseignant

Outils pour l'adulte qui prépare et accompagne.

| Feature | Notes | Effort |
|---|---|---|
| **Banque de problèmes intégrée** | Remplace les 4 presets. Classés par cycle, type, difficulté. | Moyen |
| **Export PDF** | Impression propre des modélisations | Moyen |
| **Mode démonstration / projection** | Plein écran pour TNI en classe | Petit |
