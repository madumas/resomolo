...
import { UI_SURFACE, UI_BORDER, UI_PRIMARY, UI_TEXT_PRIMARY, UI_TEXT_SECONDARY } from '../config/theme';
import { MIN_BUTTON_SIZE_PX } from '../config/accessibility';

interface ModeSelectorProps {
  readonly mode: ToolbarMode;
  readonly onChange: (mode: ToolbarMode) => void;
}

const MODES: Array<{ value: ToolbarMode; label: string; detail: string }> = [
  { value: 'essentiel', label: 'Simplifié', detail: 'Outils essentiels (2e cycle)' },
  { value: 'complet', label: 'Complet', detail: 'Tous les outils (3e cycle)' },
];
