    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 13, lineHeight: 1.5, color: UI_TEXT_PRIMARY, margin: '0 0 16px' }}>
          Jetons, barres, boîtes pour modéliser des problèmes de maths visuellement.
          L'enfant fait le raisonnement, l'outil dessine.
        </p>

        <div style={{ fontSize: 12, color: UI_TEXT_SECONDARY, marginBottom: 8 }}>
          Logiciel libre —{' '}
          <a
            href="https://github.com/madumas/resomolo"
            target="_blank"
            rel="noopener"
